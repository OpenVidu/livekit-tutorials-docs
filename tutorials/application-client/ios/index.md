...
It uses the [LiveKit Swift SDK](https://docs.livekit.io/reference/client-sdk-swift/documentation/livekit/) to connect to the LiveKit server and interact with the video call room.

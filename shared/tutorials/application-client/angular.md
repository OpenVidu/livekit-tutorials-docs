...
/// html | div.grid-50
![Join screen of the Angular tutorial app](/assets/images/tutorials/application-client/join-angular.png){ .round-corners loading=lazy }
///

/// html | div.grid-50
![Video call room of the Angular tutorial app](/assets/images/tutorials/application-client/room-angular.png){ .round-corners loading=lazy }
///

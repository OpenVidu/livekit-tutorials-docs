...
3.  Serve the application:
    ...
    === ":fontawesome-solid-mobile-screen-button:{.icon .lg-icon .tab-icon} Mobile"
        ...
        ![URL configuration of the Ionic tutorial app](/assets/images/tutorials/application-client/configure-urls-ionic.png){ .w-25 loading=lazy }
        ...
        ![Join screen of the Ionic tutorial app on a mobile device](/assets/images/tutorials/application-client/join-ionic-device.png){ .w-50 loading=lazy }
        ///

        /// html | div.grid-50.text-center
        ![Video call room of the Ionic tutorial app on a mobile device](/assets/images/tutorials/application-client/room-ionic-device.png){ .w-50 loading=lazy }
        ///

...
![Join screen of the iOS tutorial app](/assets/images/tutorials/application-client/join-ios.png){ .w-50 loading=lazy }
///

/// html | div.grid-50.text-center
![Video call room of the iOS tutorial app](/assets/images/tutorials/application-client/room-ios.png){ .w-50 loading=lazy }
///

...
A verbatim copy of openvidu.io's publish-tool/llmstxt_preprocess.py (where
tests/unit/test_llmstxt_preprocess.py compares it against the plugin's own `autoclean`);

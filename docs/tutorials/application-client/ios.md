...
[counterpart]: https://openvidu.io/latest/docs/tutorials/application-client/ios/?utm_source=livekit-tutorials&utm_medium=referral&utm_campaign=tutorial-cross-link
...
![URL configuration of the iOS tutorial app](../../assets/images/tutorials/application-client/configure-urls-ios.png){ loading=lazy style="width: 25%" }
...
![Join screen of the iOS tutorial app](../../assets/images/tutorials/application-client/join-ios.png){ loading=lazy style="width: 25%" }
